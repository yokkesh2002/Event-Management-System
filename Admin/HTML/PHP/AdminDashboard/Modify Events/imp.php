            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-dark d-flex justify-content-between">
                        <h4 class="text-center text-light">CREATE/EDIT/DELETE EVENTS</h4>
                        <a href="form.php"  class="btn bg-warning text-dark"><b>Add Events</b></a>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                        ...
                                        while($row_data = mysqli_fetch_array($select_query))
                                        {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><img src="profiles/<?php if(isset($row_data['user_profile'])){echo $row_data['user_profile']; }?>" alt="user_profile" width='60' height='60'></td>
                                                    <td>
