            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-dark d-flex justify-content-between">
                        <h4 class="text-center text-light">CREATE/EDIT/DELETE CLUBS</h4>
                        <a href="form2.php"  class="btn bg-warning text-dark"><b>Add Clubs</b></a>
                    </div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                        ...
                                        while($row_data = mysqli_fetch_array($select_query))
                                        {
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><img src="profiles2/<?php if(isset($row_data['club_logo'])){echo $row_data['club_logo']; }?>" alt="club_logo" width='60' height='60'></td>
                                                    <td>
                                                        <a href="edit2.php?id=<?php echo $row_data['id1'];?>" title='Edit'><i class="fa-solid fa-pen-to-square"></i></a>
                                                        <a href="delete2.php?id=<?php echo $row_data['id1'];?>" title='Delete'><i class="fa-solid fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php
                                        }
