...
<nav class="navbar navbar-expand-lg navbar-light navbar-laravel">
    <div class="container">
        <a class="navbar-brand" href="#">Admin Password Recover</a>
    ...
    if(isset($_POST["recover"])){
        ...
        if(mysqli_num_rows($sql) <= 0){
           ...
           <?php
            ...
            $mail->Password='jyuksnmsqxigqljr';

            // send by h-hotel email
            $mail->setFrom('yokkesh2002hackerone@gmail.com', 'Password Reset');
            ...
            http://localhost/TMS/HomePage/Candidate/HTML/ForgotPassword/reset_psw.php
            <br><br>
            <p>With regrads,</p>
            <b>TMS</b>";
